    ...
    public class CAJCobroController : Controller
    {
        ...
        public JsonResult GetCobro()
        {
            try
            {
                ...
                var CREDITO_PENDIENTE =Connect.Connect_Reportes(itemCredito);
            ...
            try
            {
                ...
                if (fel == 1)
                {
                    ...
                    if (respuestaFEL.RESULTADO)
                    {
                        ...
                        update.FEL = 1;
                        var respuesta_update = Connect.Connect_FEL(update).FirstOrDefault();
                ...
                if (formaPago == 3)
                {
                    ...
                    var respuestaCredito = Connect.Connect_Cartera(insertCredito).FirstOrDefault();
                }
